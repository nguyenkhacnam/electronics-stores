      ...
      <div className='grid grid-cols-3 items-center gap-7 h-[55px]  px-15 max-w-1500
        ...
        '>
          <div className='flex justify-between cursor-pointer'>
            ...
            <div 
              className='hover:text-primary delay-delay-100
            sm:flex sm:gap-[2px]'
